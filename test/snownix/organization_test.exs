defmodule Snownix.OrganizationTest do
  ...
  describe "projects" do
    ...
    test "create_project/1 with valid data creates a project" do
      valid_attrs = %{city: "some city", country: "some country", email: "some email", name: "some name", phone: "some phone", postal: "some postal", street: "some street", vat: "some vat"}
      ...
      assert project.postal == "some postal"
    ...
    test "update_project/2 with valid data updates the project" do
      ...
      assert project.postal == "some updated postal"
