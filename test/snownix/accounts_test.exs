defmodule Snownix.AccountsTest do
  ...
  describe "register_user/1" do
    ...
    test "validates email and password when given" do
      {:error, changeset} = Accounts.register_user(%{email: "not valid", password: "notv"})
  ...
  describe "update_user_email/2" do
    ...
    test "does not update email if token expired", %{user: user, token: token} do
      {1, nil} = Repo.update_all(UserToken, set: [inserted_at: ~N[2020-01-01 00:00:00Z]])
  ...
  describe "update_user/3" do
    ...
    test "validates current password", %{user: user} do
      {:error, changeset} =
        Accounts.update_user(user, "invalid", %{firstname: "John", lastname: "Doe"})
