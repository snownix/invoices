defmodule SnownixWeb do
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/snownix_web/templates",
        namespace: SnownixWeb
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {SnownixWeb.LayoutView, "live.html"}
  ...
  def live_dashboard do
    quote do
      use Phoenix.LiveView,
        layout: {SnownixWeb.LayoutView, "dashboard.html"}
